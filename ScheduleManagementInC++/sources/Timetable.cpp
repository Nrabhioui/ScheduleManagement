...
{
     return instance; //l'objet instance manipulable par l'app
}
...
void Timetable::load(const string& timetableName)
{
     ...
     XmlFileSerializer<Group> groupSerializer(fichierGroups,XmlFileSerializer<Group>::READ);
     cout << "Debut de lecture..." << endl;
     ...
     XmlFileSerializer<Classroom> classroomSerializer(fichierClassrooms,XmlFileSerializer<Classroom>::READ);
     cout << "Debut de lecture..." << endl;
